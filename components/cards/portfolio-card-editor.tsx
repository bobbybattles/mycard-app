...
export default function PortfolioCardEditor({ kitId, card }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Add a new group */}
      <div className="mt-4">
        {/* All 6 platforms always available — users may have multiple channels
            on the same platform (e.g. two YouTube channels) and need a group
            for each. Use the optional label to differentiate them. */}
        {showPlatformPicker ? (
